...
class CotizacionPage:
    ...
    def _actualizar_resumen(self, _evento=None):
        ...
        self.resumen_plan.set_content(f'''<div class="av-selected-grid">
          <div class="av-selected-box"><div class="av-selected-label">Plan seleccionado</div><div class="av-selected-value">{escape(plan.nombre)}</div><div class="av-choice-text">Tasa anual: {plan.tasa_anual}%</div></div>
          <div class="av-selected-box"><div class="av-selected-label">Plazo seleccionado</div><div class="av-selected-value">{plazo}</div></div>
        </div>''')
