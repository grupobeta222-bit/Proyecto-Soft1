    ...
    def _mostrar_plan(self, plan):
        ...
        with ui.card().style("background:#141414;border:1px solid #242424;border-radius:22px;padding:22px;color:#fff;"):
            ...
            ui.html(f'''<div style="display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px;margin-bottom:18px;">
              <div style="background:#1b1b1b;border-radius:14px;padding:14px;"><div style="color:#777;font-size:12px;">Entrada mínima</div><div style="font-size:22px;font-weight:900;">{plan.entrada_minima_porcentaje}%</div></div>
              <div style="background:#1b1b1b;border-radius:14px;padding:14px;"><div style="color:#777;font-size:12px;">Tasa anual</div><div style="font-size:22px;font-weight:900;">{plan.tasa_anual}%</div></div>
              <div style="background:#1b1b1b;border-radius:14px;padding:14px;"><div style="color:#777;font-size:12px;">Plazos</div><div style="font-weight:900;">{plazos} meses</div></div>
              <div style="background:#1b1b1b;border-radius:14px;padding:14px;"><div style="color:#777;font-size:12px;">Comisión</div><div style="font-size:22px;font-weight:900;">{money(plan.comision_apertura)}</div></div>
            </div>''')
