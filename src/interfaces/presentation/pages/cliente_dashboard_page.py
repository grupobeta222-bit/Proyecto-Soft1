...
class ClienteDashboardPage:
    ...
    def _sidebar(self):
        ...
        with ui.element("div").style("background:#121212;border:1px solid #333;border-radius:12px;padding:20px;display:flex;flex-direction:column;gap:10px;"):
            ui.html(f'''<div style="text-align:center;margin-bottom:20px;">
              <div style="width:80px;height:80px;background:#e63946;border-radius:50%;margin:0 auto 10px;display:flex;align-items:center;justify-content:center;font-size:32px;font-weight:bold;color:#fff;">{escape(nombre[0].upper())}</div>
