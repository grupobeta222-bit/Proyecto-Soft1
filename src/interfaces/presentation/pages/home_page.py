...
class HomePage:
            ...
            with ui.element("div").classes("av-hero-layout"):
                ...
                with ui.element("div").classes("av-hero-visual"):
                    ui.html('''<div class="av-hero-car-card">
                      ...
                      <div class="av-hero-price-row"><div class="av-hero-price"><span>Desde</span>$25,990</div><div style="font-size:12px;color:#777;line-height:1.5;text-align:right;">Entrada desde 20%<br>Plazos hasta 72 meses</div></div>
                    </div>''')
        ...
        with ui.element("div").style("background:#111;padding:80px 0;"):
            with ui.element("div").classes("av-section"):
                ...
                ui.html('''<div class="av-benefits">
                  <div class="av-benefit"><div class="av-benefit-icon">✔</div><div class="av-benefit-title">Planes flexibles</div><div class="av-benefit-desc">Desde 12 hasta 72 meses. Elige el plazo que mejor se adapte a tu presupuesto.</div></div>
                  <div class="av-benefit"><div class="av-benefit-icon">⚡</div><div class="av-benefit-title">Respuesta rápida</div><div class="av-benefit-desc">Un asesor te contacta en menos de 24 horas tras enviar tu solicitud.</div></div>
                  <div class="av-benefit"><div class="av-benefit-icon">👤</div><div class="av-benefit-title">Atención personalizada</div><div class="av-benefit-desc">Cada cliente tiene un asesor asignado durante todo el proceso.</div></div>
                  <div class="av-benefit"><div class="av-benefit-icon">💰</div><div class="av-benefit-title">Tasas competitivas</div><div class="av-benefit-desc">Tasas desde el 8.5% anual. Transparencia total en cada cuota.</div></div>
                </div>''')
    ...
    def _vehiculos_destacados(self):
        with ui.element("div").style("background:#0f0f0f;padding:80px 0;"):
            with ui.element("div").classes("av-section"):
                ...
                ui.button("Ver todos los vehículos →", on_click=lambda: ui.navigate.to("/catalogo")).classes("av-btn-s").style("display:block;margin:32px auto 0;")
        ...
        with ui.element("div").style("background:#111;padding:80px 0;"):
            with ui.element("div").classes("av-section").style("text-align:center;"):
                ...
                ui.html('''<div class="av-steps-grid">
                  <a href="/catalogo" style="text-decoration:none;color:inherit;"><div class="av-step"><div class="av-step-num">1</div><div class="av-step-title">Selecciona tu vehículo</div><div class="av-step-desc">Explora el catálogo y elige el que más te gusta.</div></div></a>
                  <a href="/cotizar" style="text-decoration:none;color:inherit;"><div class="av-step"><div class="av-step-num">2</div><div class="av-step-title">Configura tu financiamiento</div><div class="av-step-desc">Ajusta la entrada y el plazo con nuestra calculadora.</div></div></a>
                  <a href="/cotizar" style="text-decoration:none;color:inherit;"><div class="av-step"><div class="av-step-num">3</div><div class="av-step-title">Recibe tu cotización</div><div class="av-step-desc">Cuota mensual, amortización y resumen completo.</div></div></a>
                  <a href="/contacto" style="text-decoration:none;color:inherit;"><div class="av-step"><div class="av-step-num">4</div><div class="av-step-title">Un asesor te contacta</div><div class="av-step-desc">El asesor asignado continúa el proceso comercial.</div></div></a>
                </div>''')
    ...
    def _avatar(testimonio):
        ...
        if testimonio.foto_url:
            ...
            return f'<img src="{foto}" style="width:70px;height:70px;border-radius:50%;margin-bottom:15px;border:3px solid #333;object-fit:cover;" alt="{nombre}">'
        return f'<div style="width:70px;height:70px;border-radius:50%;margin:0 auto 15px;background:#e63946;color:#fff;display:flex;align-items:center;justify-content:center;font-weight:800;font-size:22px;border:3px solid #333;">{escape(testimonio.iniciales)}</div>'
