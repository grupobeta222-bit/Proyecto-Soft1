...
class CatalogoPage:
    ...
    def _crear_filtros(self):
        ...
        with ui.element("div").classes("av-search-bar"):
            self.busqueda = ui.input(placeholder="Buscar por marca o modelo...", on_change=self._renderizar).style("flex:1;min-width:210px;")
            ...
            self.precio = ui.number(label="Precio máximo", value=50000, min=0, step=1000).style("min-width:150px;")
